...
namespace brilliance\pluginkeygenerator\assetbundles\pluginkeygenerator;
...
/**
 * PluginKeyGeneratorAsset AssetBundle
 *
 ...
 * @since     3.0.0
 */
class PluginKeyGeneratorAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@brilliance/pluginkeygenerator/assetbundles/pluginkeygenerator/dist";
        ...
        $this->js = [
            'js/PluginKeyGenerator.js',
        ];

        $this->css = [
            'css/PluginKeyGenerator.css',
        ];
